Page({
  data: {
    incomes: [
      ...
      { id: 2, title: '北大第三医院·全程陪诊', time: '2026-05-30 14:00-17:00', amount: 320, status: '已结算', statusClass: 'settled' },
  ...
  doWithdraw() {
    wx.showModal({ title: '确认提现', content: '将提现 ¥1,880.00 到微信零钱', success(r) { if (r.confirm) wx.showToast({ title: '提现申请已提交', icon: 'success' }) } })
  }
})
