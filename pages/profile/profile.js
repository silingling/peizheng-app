...
Page({
  data: {
    ...
    recordsCount: app.globalData.medicalRecords.length || 3,
    recentOrders: [
      { id: 1, hospital: '北京协和医院', dept: '内科', date: '06-01', statusText: '待服务', statusClass: 'pending' },
      { id: 2, hospital: '北大第三医院', dept: '骨科', date: '05-30', statusText: '进行中', statusClass: 'ongoing' },
      { id: 3, hospital: '北京协和医院', dept: '心内科', date: '05-28', statusText: '已完成', statusClass: 'done' }
    ]
  },
  onShow() { this.setData({ recordsCount: app.globalData.medicalRecords.length || 3 }) },
